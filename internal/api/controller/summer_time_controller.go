...
type SummerTimeController struct {
	searchUseCase *fxusecase.SearchSummerTimeUseCase
	addUseCase    *fxusecase.AddSummerTimeUseCase
	getUseCase    *fxusecase.GetSummerTimeUseCase
	updateUseCase *fxusecase.UpdateSummerTimeUseCase
}
...
func (ctrl *SummerTimeController) Search(c *gin.Context) {
	...
	c.JSON(http.StatusOK, response.SummerTimeSearchResponse{
