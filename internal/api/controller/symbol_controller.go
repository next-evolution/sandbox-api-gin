...
type SymbolController struct {
	searchUseCase *fxusecase.SearchSymbolUseCase
	addUseCase    *fxusecase.AddSymbolUseCase
	getUseCase    *fxusecase.GetSymbolUseCase
	updateUseCase *fxusecase.UpdateSymbolUseCase
}
...
func (ctrl *SymbolController) Search(c *gin.Context) {
	...
	c.JSON(http.StatusOK, response.SymbolSearchResponse{
