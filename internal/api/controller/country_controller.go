...
type CountryController struct {
	searchUseCase *fxusecase.SearchCountryUseCase
	addUseCase    *fxusecase.AddCountryUseCase
	getUseCase    *fxusecase.GetCountryUseCase
	updateUseCase *fxusecase.UpdateCountryUseCase
}
...
func (ctrl *CountryController) Search(c *gin.Context) {
	...
	c.JSON(http.StatusOK, response.CountrySearchResponse{
